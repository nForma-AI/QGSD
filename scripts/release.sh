...
echo ""
echo "IMPORTANT: If this is a stable release (no -rc suffix), release.yml"
echo "will automatically align @next to match @latest."
echo "If this is a prerelease, it publishes to @next only."
echo ""
