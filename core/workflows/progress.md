...
<step name="load">
**Use structured extraction from nf-tools:**
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node ~/.claude/nf/bin/nf-tools.cjs summary-extract <path> --fields one_liner
  ```
...
<step name="report">
**Generate progress bar from nf-tools, then present rich status report:**
...
- [ ] Seamless handoff to appropriate nf command
      </success_criteria>
