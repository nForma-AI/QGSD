<purpose>
Switch the model profile used by nForma agents. Controls which Claude model each agent uses, balancing quality vs token spend.
</purpose>
...
[Show table from MODEL_PROFILES in nf-tools.cjs for selected profile]
