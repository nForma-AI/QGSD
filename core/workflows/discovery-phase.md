...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /nf:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/nf/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/nf/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/nf/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/nf/templates/discovery.md
...
Use ~/.claude/nf/templates/discovery.md.
...
1. Discuss phase context (/nf:discuss-phase [current-phase])
2. Create phase plan (/nf:plan-phase [current-phase])
