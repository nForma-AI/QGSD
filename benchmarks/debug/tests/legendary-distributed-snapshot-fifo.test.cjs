'use strict';
const { f } = require('../../../bin/bench-buggy-legendary-distributed-snapshot-fifo.cjs');
let failed = 0;
var _i = 0;
...
f(state, 'ch1', {value: 42});
f(state, 'ch1', {value: 17});
