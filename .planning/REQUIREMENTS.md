...
- [ ] **ROUTE-01**: quick.md Step 2.7 Haiku subagent classifies task as bug_fix | feature | refactor
...
- [ ] **ROUTE-04**: Classification result stored in scope-contract.json for downstream consumers
