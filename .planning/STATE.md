...
| 97 | Add update management for all sub-coding agents to manage-agents.cjs | 2026-02-24 | {commit_hash} | Pending | [97-add-update-management-for-all-sub-coding](./quick/97-add-update-management-for-all-sub-coding/) |
