...
| 144 | Make /qgsd:solve fully autonomous — add --project-root to diagnostic scripts, rewrite solve.md for autonomy, add --batch to close-formal-gaps | 2026-03-04 | pending | Pending | [144-make-qgsd-solve-fully-autonomous-add-pro](./quick/144-make-qgsd-solve-fully-autonomous-add-pro/) |
