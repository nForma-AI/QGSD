...
| 113 | create a flag that allows to control the number of max member in the quorum | 2026-02-27 | TBD | Pending | [113-create-a-flag-that-allows-to-control-the](./quick/113-create-a-flag-that-allows-to-control-the/) |
...
Last activity: 2026-02-27 - Completed quick task 113: create a flag --n N to control quorum size
