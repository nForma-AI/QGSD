...
- **After every task commit:** Run `node --test bin/check-bundled-sdks.test.cjs`
...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| v0.26-05-01-01 | 01 | 1 | ARCH-10 | unit | `node --test bin/check-bundled-sdks.test.cjs` | TBD | ⬜ pending |
| v0.26-05-01-02 | 01 | 1 | ARCH-10 | integration | `npm test` | TBD | ⬜ pending |
| v0.26-05-01-03 | 01 | 1 | ARCH-10 | smoke | `node bin/check-bundled-sdks.cjs` | TBD | ⬜ pending |
...
- [ ] `bin/check-bundled-sdks.test.cjs` — stubs for ARCH-10 linter tests
- [ ] Test fixtures: files with SDK imports for detection testing
