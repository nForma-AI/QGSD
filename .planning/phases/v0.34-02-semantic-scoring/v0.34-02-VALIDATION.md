...
# Phase v0.34-02 — Validation Strategy

> Template created by `/nf:plan-phase v0.34-02` (step 5.5) after research.
> Populated by `/nf:plan-phase v0.34-02` (step 11.5) after plan-checker approval.
> Governs feedback sampling during `/nf:execute-phase v0.34-02`.
...
Updated during `/nf:execute-phase v0.34-02`:
