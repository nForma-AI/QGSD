...
- [ ] **INDEX-01**: PostToolUse hook indexes files after Write/Edit operations
- [ ] **INDEX-02**: Index tracks file paths, exports, and imports
- [ ] **INDEX-03**: Index stored in `.planning/intel/index.json`
- [ ] **INDEX-04**: Hook fails silently on any error (never blocks Claude)
- [ ] **INDEX-05**: Index updates incrementally (add/modify, not full rebuild)
...
- [ ] **CONV-06**: Conventions stored in `.planning/intel/conventions.json`
