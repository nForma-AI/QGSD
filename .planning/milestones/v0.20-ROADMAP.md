...
- [x] **Phase v0.20-09: Restore TLA+ Planning Gate** — Re-insert `run-formal-verify --only=tla` gate and `FV_HYPOTHESES` extraction that was overwritten by v0.20-08; all 6 `plan-phase-fv-gate.test.cjs` tests pass GREEN (PLAN-01, PLAN-02) [gap closure] (completed 2026-03-01)
