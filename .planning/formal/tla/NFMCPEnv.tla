 ...
 *     nf-prompt.js; not a separate TLC branch (see environment.md Section 5)
 *   - quorumPhase: "COLLECTING" | "DECIDING" | "DECIDED"
 *     ("DELIBERATING" is in NFDeliberation.tla; this module models the MCP layer)
 *
