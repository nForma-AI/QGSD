...
- Provider assignments:
  ...
  - claude-4 (fireworks): model accounts/fireworks/models/kimi-k2p5, key fw_3ZRUprvwRJAsGpexjYdnDC8A
...
- claude-4: Fireworks, ANTHROPIC_BASE_URL=https://api.fireworks.ai/inference/v1, ANTHROPIC_API_KEY=fw_3ZRUprvwRJAsGpexjYdnDC8A, ANTHROPIC_MODEL=accounts/fireworks/models/kimi-k2p5, quorum_timeout_ms=30000
...
- claude-6: Fireworks, ANTHROPIC_BASE_URL=https://api.fireworks.ai/inference/v1, ANTHROPIC_API_KEY=fw_3ZRUprvwRJAsGpexjYdnDC8A, ANTHROPIC_MODEL=accounts/fireworks/models/glm-5, quorum_timeout_ms=8000
