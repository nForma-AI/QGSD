...
<details>
<summary>✅ v0.15 — Health & Tooling Modernization (Phases v0.15-01..v0.15-04) — SHIPPED 2026-02-27</summary>
...
**Archive:** `.planning/milestones/v0.15-ROADMAP.md`

</details>

### 🔍 v0.18 — Token Efficiency (AUDIT: gaps_found)
...
- [ ] **Phase v0.18-06: FAN-04 Stop Hook Ceiling Fix** — Restructure `qgsd-stop.js:479` so `wasSlotWorkerUsed()=true` no longer short-circuits before `parseQuorumSizeFlag()` ceiling check; update FAN-STOP-TC1..TC4 to exercise ceiling path; dist+install sync (FAN-04) (Gap Closure)
...
<details>
<summary>✅ v0.20 — FV as Active Planning Gate (Phases v0.20-01..v0.20-09) — SHIPPED 2026-03-01</summary>

- [x] **Phase v0.20-01: Schema Enrichment** — check-result.schema.json → v2.1 spec; writeCheckResult v2.1; all 21 callers updated (SCHEMA-01–03) — completed 2026-02-28
- [x] **Phase v0.20-02: Liveness Fairness Lint** — ci:liveness-fairness-lint detects liveness without fairness → result=inconclusive (LIVE-01/02) — completed 2026-02-28
- [x] **Phase v0.20-03: Planning Gate** — plan-phase.md step 8.3 runs TLA+ pre-quorum; FV_HYPOTHESES surfaced fail-open (PLAN-01–03) — completed 2026-02-28
- [x] **Phase v0.20-04: Verification Gate** — qgsd-verifier runs FV post-implementation; VERIFICATION.md gains ## Formal Verification section (VERIFY-01/02) — completed 2026-02-28
- [x] **Phase v0.20-05: Evidence Confidence** — never_observed confidence tiers; observation_window metadata in NDJSON (EVID-01/02) — completed 2026-02-28
- [x] **Phase v0.20-06: Triage Bundle** — generate-triage-bundle.cjs produces diff-report.md + suspects.md after every FV run (TRIAGE-01/02) — completed 2026-02-28
- [x] **Phase v0.20-07: UPPAAL Timed Race Modeling** — quorum-races.xml timed automaton with empirical runtime_ms clock guards; TCTL queries (UPPAAL-01–03) — completed 2026-02-28
- [x] **Phase v0.20-08: Sensitivity Analysis** — run-sensitivity-sweep.cjs sweeps MaxSize/tp_rate; SENSITIVITY_CONTEXT injected into quorum (SENS-01–03) — completed 2026-02-28
- [x] **Phase v0.20-09: Restore TLA+ Planning Gate** — re-insert TLA+ gate at step 8.2 (before sensitivity at 8.3); 6/6 tests GREEN (PLAN-01/02) — completed 2026-03-01
...
- [x] **Phase v0.21-06: Operational Signals** — detect-coverage-gaps.cjs; generate-petri-net.cjs --roadmap; prism-priority.cjs; quorum-consensus-gate.cjs Poisson binomial gate (SIG-01, SIG-02, SIG-03, SIG-04) (completed 2026-03-01)

**Archive:** `.planning/milestones/v0.21-ROADMAP.md`
...
Plans:
- [x] v0.18-03-01-PLAN.md — TDD: bin/task-envelope.cjs init/update/validate + test suite (ENV-01, ENV-02) (completed 2026-02-27)
- [x] v0.18-03-02-PLAN.md — config-loader.js task_envelope_enabled key + dist sync + ENV-04 unit tests (ENV-04) (completed 2026-02-27)
...
| v0.18-04. Adaptive Fan-Out | v0.18 | Complete    | 2026-02-27 | 2026-02-27 |
...
| v0.20-01. Schema Enrichment | v0.20 | 5/5 | Complete | 2026-02-28 |
| v0.20-02. Liveness Fairness Lint | v0.20 | 3/3 | Complete | 2026-02-28 |
| v0.20-03. Planning Gate | v0.20 | 2/2 | Complete | 2026-02-28 |
| v0.20-04. Verification Gate | v0.20 | 3/3 | Complete | 2026-02-28 |
| v0.20-05. Evidence Confidence | v0.20 | 3/3 | Complete | 2026-02-28 |
| v0.20-06. Triage Bundle | v0.20 | 3/3 | Complete | 2026-02-28 |
| v0.20-07. UPPAAL Timed Race Modeling | v0.20 | 4/4 | Complete | 2026-02-28 |
| v0.20-08. Sensitivity Analysis | v0.20 | 3/4 | Complete | 2026-02-28 |
...
| v0.21-01. Central Model Registry | v0.21 | 4/4 | Complete    | 2026-03-01 |
| v0.21-02. Conformance Crisis Fix | v0.21 | 4/4 | Complete    | 2026-03-01 |
| v0.21-03. Self-Calibrating Feedback Loops | v0.21 | 5/5 | Complete    | 2026-03-01 |
| v0.21-04. Spec Completeness | v0.21 | 4/4 | Complete    | 2026-03-01 |
| v0.21-05. Planning Integration | v0.21 | 3/3 | Complete    | 2026-03-01 |
| v0.21-06. Operational Signals | v0.21 | 4/4 | Complete    | 2026-03-01 |

> **v0.21 phase details archived to** `.planning/milestones/v0.21-ROADMAP.md`
...
Plans:
- [ ] v0.22-01-01-PLAN.md — TDD: aggregate-requirements.cjs parser + JSON Schema + deterministic output (ENV-01)
- [ ] v0.22-01-02-PLAN.md — TDD: validate-requirements-haiku.cjs Haiku semantic validator + freeze workflow (ENV-02)
- [ ] v0.22-01-03-PLAN.md — Integration: end-to-end aggregation + validation + freeze on real REQUIREMENTS.md (ENV-01, ENV-02)
...
<details>
<summary>✅ v0.23 — Formal Gates (Phases v0.23-01..v0.23-04) — SHIPPED 2026-03-02</summary>

- [x] Phase v0.23-01: plan-phase Formal Integration (2/2 plans) — completed 2026-03-02
- [x] Phase v0.23-02: execute-phase + Verifier Formal Integration (4/4 plans) — completed 2026-03-02
- [x] Phase v0.23-03: Roadmapper Formal Integration (4/4 plans) — completed 2026-03-02
- [x] Phase v0.23-04: Integration Validation Suite (2/2 plans) — completed 2026-03-02

**Archive:** `.planning/milestones/v0.23-ROADMAP.md`
...
| v0.23-03. Roadmapper Formal Integration | v0.23 | Complete    | 2026-03-02 | - |
| v0.23-04. Integration Validation Suite | v0.23 | Complete    | 2026-03-02 | - |

<details>
<summary>✅ v0.24 — Quorum Reliability Hardening (Phases v0.24-01..v0.24-05) — SHIPPED 2026-03-03</summary>

- [x] **Phase v0.24-01: Provider Infrastructure and Failover** — Explicit provider-to-slot mapping + retry-with-backoff (4/4 plans, FAIL-01+FAIL-02 verified)
- [x] **Phase v0.24-02: Dispatch Reliability** — Pre-dispatch health probes, availability windows, success-rate ordering (3/3 plans, DISP-01–03 verified)
- [x] **Phase v0.24-03: Quorum Observability** — Structured telemetry, delivery rate tracking, flakiness scoring (3/3 plans, OBS-01–03 verified)
- [x] **Phase v0.24-04: Self-Healing Consensus** — Early escalation + maxDeliberation auto-adjust (3/3 plans, HEAL-01+HEAL-02 verified)
- [x] **Phase v0.24-05: Slot Worker Thin Passthrough** — Prompt construction + output parsing in JS; 22-25k → 11-12k tokens (4/4 plans, DISP-04+DISP-05 verified)

**Archive:** `.planning/milestones/v0.24-ROADMAP.md`
...
<details>
<summary>✅ v0.25 — Formal Traceability & Coverage (Phases v0.25-01..v0.25-07) — SHIPPED 2026-03-03</summary>

- [x] Phase v0.25-01: Schema Foundation (3/3 plans) — completed 2026-03-03
- [x] Phase v0.25-02: Property Annotations (3/3 plans) — completed 2026-03-03
- [x] Phase v0.25-03: Traceability Matrix (2/2 plans) — completed 2026-03-03
- [x] Phase v0.25-04: Bidirectional Validation (2/2 plans) — completed 2026-03-03
- [x] Phase v0.25-05: Decomposition Awareness (3/3 plans) — completed 2026-03-03
- [x] Phase v0.25-06: Annotation Regression Fix (2/2 plans) — completed 2026-03-03 (Gap Closure)
- [x] Phase v0.25-07: Retroactive Verification & Bookkeeping (2/2 plans) — completed 2026-03-03 (Gap Closure)

Archive: .planning/milestones/v0.25-ROADMAP.md

</details>

| v0.25-01. Schema Foundation | v0.25 | 3/3 | Complete | 2026-03-03 |
| v0.25-02. Property Annotations | v0.25 | 3/3 | Complete | 2026-03-03 |
| v0.25-03. Traceability Matrix | v0.25 | 2/2 | Complete | 2026-03-03 |
| v0.25-04. Bidirectional Validation | v0.25 | 2/2 | Complete | 2026-03-03 |
| v0.25-05. Decomposition Awareness | v0.25 | 3/3 | Complete | 2026-03-03 |
| v0.25-06. Annotation Regression Fix | v0.25 | 2/2 | Complete | 2026-03-03 |
| v0.25-07. Retroactive Verification | v0.25 | 2/2 | Complete | 2026-03-03 |

### v0.26 — Operational Completeness
...
**Goal**: Users can control quorum behavior per slot through dedicated policy settings
...
**Plans**: 3 plans
- [x] v0.26-01-01-PLAN.md -- Input validation for timeout and policy values
- [x] v0.26-01-02-PLAN.md -- Wire PLCY-03 auto-update check into startup
...
**Depends on**: Phase v0.26-02
**Requirements**: PORT-01, PORT-02, PORT-03, PRST-01, PRST-02, REN-03
**Success Criteria** (what must be TRUE):
  1. User can export full roster config to a JSON file where all API key values are replaced with `__redacted__` placeholders
  2. User can import roster config from a JSON file — schema is validated, redacted keys prompt for re-entry, and user confirms before applying
  3. Import creates a timestamped backup of `~/.claude.json` before applying any changes
...
**Depends on**: Nothing (can parallel with Phase v0.26-03)
**Requirements**: DASH-01, DASH-02, DASH-03
**Success Criteria** (what must be TRUE):
  1. User can open a live health dashboard from the main menu showing all slots' provider, model, and health status
  2. Dashboard refreshes on keypress (space / r) with a visible "last updated" timestamp at the bottom
  3. Dashboard exits cleanly on Q or Escape, returning to main menu with stdin fully restored (no character-swallowing after exit)
**Plans**: TBD

### Phase v0.26-05: Architecture Enforcement
**Goal**: QGSD structurally prevents LLM SDK bundling
**Depends on**: Nothing (pure CI gate)
...
**Depends on**: Phase v0.26-01 (policy config informs timeout budgets)
...
**Execution Order:**
Phases execute in order: v0.26-01 -> v0.26-02 -> v0.26-03 -> v0.26-04 (parallel) -> v0.26-05 (parallel) -> v0.26-06
