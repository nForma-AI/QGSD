...
Plans:
- [x] v0.20-01-01-PLAN.md — Schema v2.1 update + Wave 0 RED tests (SCHEMA-01, SCHEMA-02)
- [x] v0.20-01-02-PLAN.md — Upgrade writeCheckResult to v2.1 signature (SCHEMA-02)
- [x] v0.20-01-03-PLAN.md — Update 5 TLA+ caller scripts (SCHEMA-03)
- [x] v0.20-01-04-PLAN.md — Update 5 Alloy + 2 PRISM + 2 CI caller scripts (SCHEMA-03)
- [x] v0.20-01-05-PLAN.md — Integration smoke + NDJSON v2.1 validation (SCHEMA-01, SCHEMA-02, SCHEMA-03)
