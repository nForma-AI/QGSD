...
description: Verifies plans will achieve phase goal before execution. Goal-backward analysis of plan quality. Spawned by /nf:plan-phase orchestrator.
...
**Question:** Do plans honor user decisions from /nf:discuss-phase?
...
Plans verified. Run `/nf:execute-phase {phase}` to proceed.
```
