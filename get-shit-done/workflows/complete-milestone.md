...
2. **Run audit first** — `/qgsd:audit-milestone` to assess gap severity
...
If "Skip": Phase directories remain in `.planning/phases/` as raw execution history. Use `/qgsd:cleanup` later to archive retroactively.
...
- [ ] User knows next step (/qgsd:new-milestone)
