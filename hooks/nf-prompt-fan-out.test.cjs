#!/usr/bin/env node
// hooks/nf-prompt-fan-out.test.cjs — Wave 0 test scaffold for FAN-04, FAN-06
// Integration tests for nf-prompt.js fan-out logic
...
// Tests verify that nf-prompt.js reads risk_level from context and emits --n N flag.
...
// Helper: spawn nf-prompt.js as child process with stdin
