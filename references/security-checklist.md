...
Use this checklist when reviewing changes that touch trust boundaries, secrets, authentication, or external integrations. Pairs with the `security-and-hardening` packaged skill.
